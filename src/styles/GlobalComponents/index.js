...
export const SectionTitle = styled.h2`
	...
	background-size: 200% 200%; /* Allows for the shimmer effect */
	-webkit-background-clip: text;
	-webkit-text-fill-color: transparent;
	margin-bottom: 16px;
	padding: ${(props) => (props.main ? "58px 0 16px" : "0")};
	animation: ${shimmer} 8s linear infinite; /* Smooth shimmering animation */
...
export const SecondaryBtn = styled.button`
	...
	&:hover {
		color: #fff;
		background: #000; /* Reverse gradient on hover */
	}
